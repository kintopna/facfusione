...
from facfusione.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = facfusione.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(facfusione.choices.system_memory_limit_range),
		minimum = facfusione.choices.system_memory_limit_range[0],
		maximum = facfusione.choices.system_memory_limit_range[-1],
