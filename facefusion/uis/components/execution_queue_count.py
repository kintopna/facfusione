...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(facfusione.choices.execution_queue_count_range),
		minimum = facfusione.choices.execution_queue_count_range[0],
		maximum = facfusione.choices.execution_queue_count_range[-1]
	)
